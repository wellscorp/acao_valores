...
class MudarSenhaFilter extends InputFilter {
    ...
    public function __construct(){
        ...
        $senhaAtual= new Input('senha_atual');
        $senhaAtual->setRequired(true)        // TRUE= OBRIGADO A INSERIR
        ->getFilterChain()
            ->attach(new StringTrim())      //REMOVE ESPAÇOS EM BRANCO
            ->attach(new StripTags());
        $senhaAtual->getValidatorChain()->attach(new NotEmpty());
        $this->add($senhaAtual);

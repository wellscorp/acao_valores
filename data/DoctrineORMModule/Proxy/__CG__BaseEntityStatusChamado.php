 ...
 */
class StatusChamado extends \Base\Entity\StatusChamado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\StatusChamado' . "\0" . 'id', '' . "\0" . 'Base\\Entity\\StatusChamado' . "\0" . 'descricao', '' . "\0" . 'Base\\Entity\\StatusChamado' . "\0" . 'idEmpresa');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StatusChamado $proxy) {

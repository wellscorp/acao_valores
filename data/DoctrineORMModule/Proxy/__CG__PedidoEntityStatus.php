...
namespace DoctrineORMModule\Proxy\__CG__\Pedido\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Status extends \Pedido\Entity\Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Pedido\\Entity\\Status' . "\0" . 'idStatus', '' . "\0" . 'Pedido\\Entity\\Status' . "\0" . 'descricao');
        }

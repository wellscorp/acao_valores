 ...
 */
class StatusOportunidade extends \Base\Entity\StatusOportunidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\StatusOportunidade' . "\0" . 'id', '' . "\0" . 'Base\\Entity\\StatusOportunidade' . "\0" . 'descricao', '' . "\0" . 'Base\\Entity\\StatusOportunidade' . "\0" . 'idEmpresa');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StatusOportunidade $proxy) {

 ...
 */
class Area extends \Base\Entity\Area implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Area' . "\0" . 'id', '' . "\0" . 'Base\\Entity\\Area' . "\0" . 'descricao', '' . "\0" . 'Base\\Entity\\Area' . "\0" . 'idEmpresa');
        }

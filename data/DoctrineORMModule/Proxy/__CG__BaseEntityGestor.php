 ...
 */
class Gestor extends \Base\Entity\Gestor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Gestor' . "\0" . 'idGestor', '' . "\0" . 'Base\\Entity\\Gestor' . "\0" . 'nome', '' . "\0" . 'Base\\Entity\\Gestor' . "\0" . 'email', '' . "\0" . 'Base\\Entity\\Gestor' . "\0" . 'idEmpresa');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gestor $proxy) {

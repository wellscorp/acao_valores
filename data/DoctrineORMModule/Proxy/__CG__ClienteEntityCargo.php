 ...
 */
class Cargo extends \Cliente\Entity\Cargo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cliente\\Entity\\Cargo' . "\0" . 'id', '' . "\0" . 'Cliente\\Entity\\Cargo' . "\0" . 'descricao', '' . "\0" . 'Cliente\\Entity\\Cargo' . "\0" . 'idEmpresa');
        }

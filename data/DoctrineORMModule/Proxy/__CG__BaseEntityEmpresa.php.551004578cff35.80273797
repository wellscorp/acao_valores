 ...
 */
class Empresa extends \Base\Entity\Empresa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'id', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'status', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'razaoSocial', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'cnpj', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'inscricaoEstadual', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'inscricaoMunicipal', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'nomeFantasia', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'cep', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'estado', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'cidade', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'endereco', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'bairro', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'telefone', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'email', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'dtCriacao', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'hrCriacao', '' . "\0" . 'Base\\Entity\\Empresa' . "\0" . 'imagemLink');
        }
    ...
    public function setImagemLink($imagemLink)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setImagemLink', array($imagemLink));

        return parent::setImagemLink($imagemLink);
    }
    ...
    public function getImagemLink()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getImagemLink', array());

        return parent::getImagemLink();
    }

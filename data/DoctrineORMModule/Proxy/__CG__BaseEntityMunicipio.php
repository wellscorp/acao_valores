 ...
 */
class Municipio extends \Base\Entity\Municipio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Municipio' . "\0" . 'id', '' . "\0" . 'Base\\Entity\\Municipio' . "\0" . 'descricao', '' . "\0" . 'Base\\Entity\\Municipio' . "\0" . 'estado');
        }

...
namespace DoctrineORMModule\Proxy\__CG__\Gerente\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Gerente extends \Gerente\Entity\Gerente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'id', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'nome', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'cpf', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'rg', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'dataNasc', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'endereco', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'numero', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'bairro', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'cidade', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'codCidade', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'cep', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'estado', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'usuario', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'dataCriacao', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'horaCriacao', '' . "\0" . 'Gerente\\Entity\\Gerente' . "\0" . 'idEmpresa');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gerente $proxy) {

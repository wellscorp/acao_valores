 ...
 */
class Grupo extends \grupo\Entity\Grupo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'grupo\\Entity\\Grupo' . "\0" . 'id', '' . "\0" . 'grupo\\Entity\\Grupo' . "\0" . 'nome', '' . "\0" . 'grupo\\Entity\\Grupo' . "\0" . 'dtCriacao', '' . "\0" . 'grupo\\Entity\\Grupo' . "\0" . 'hrCriacao', '' . "\0" . 'grupo\\Entity\\Grupo' . "\0" . 'observacao');
        }

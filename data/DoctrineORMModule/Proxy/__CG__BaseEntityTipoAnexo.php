 ...
 */
class TipoAnexo extends \Base\Entity\TipoAnexo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\TipoAnexo' . "\0" . 'id', '' . "\0" . 'Base\\Entity\\TipoAnexo' . "\0" . 'descricao', '' . "\0" . 'Base\\Entity\\TipoAnexo' . "\0" . 'idEmpresa');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoAnexo $proxy) {
    ...
    public function getIdTipoAnexo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdTipoAnexo', array());

        return parent::getIdTipoAnexo();
    }

 ...
 */
class Vendedor extends \Base\Entity\Vendedor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Vendedor' . "\0" . 'idVendedor', '' . "\0" . 'Base\\Entity\\Vendedor' . "\0" . 'nome', '' . "\0" . 'Base\\Entity\\Vendedor' . "\0" . 'email', '' . "\0" . 'Base\\Entity\\Vendedor' . "\0" . 'idEmpresa');
        }
    ...
    public function getIdVendedor()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdVendedor();
        }

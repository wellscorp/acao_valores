 ...
 */
class Solucao extends \Base\Entity\Solucao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Solucao' . "\0" . 'id', '' . "\0" . 'Base\\Entity\\Solucao' . "\0" . 'descricao', '' . "\0" . 'Base\\Entity\\Solucao' . "\0" . 'idEmpresa');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Solucao $proxy) {

 ...
 */
class Agente extends \Base\Entity\Agente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Agente' . "\0" . 'idAgente', '' . "\0" . 'Base\\Entity\\Agente' . "\0" . 'nome', '' . "\0" . 'Base\\Entity\\Agente' . "\0" . 'email', '' . "\0" . 'Base\\Entity\\Agente' . "\0" . 'idEmpresa');
        }

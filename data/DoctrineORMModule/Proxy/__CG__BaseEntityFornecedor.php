 ...
 */
class Fornecedor extends \Base\Entity\Fornecedor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Fornecedor' . "\0" . 'id', '' . "\0" . 'Base\\Entity\\Fornecedor' . "\0" . 'nome', '' . "\0" . 'Base\\Entity\\Fornecedor' . "\0" . 'idEmpresa');
        }

...
namespace DoctrineORMModule\Proxy\__CG__\Vendedor\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Vendedor extends \Vendedor\Entity\Vendedor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'id', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'nome', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'cpf', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'rg', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'dataNasc', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'endereco', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'numero', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'bairro', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'cidade', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'codCidade', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'cep', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'estado', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'usuario', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'dataCriacao', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'horaCriacao', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'idGerente', '' . "\0" . 'Vendedor\\Entity\\Vendedor' . "\0" . 'idEmpresa');
        }
    ...
    public function setIdGerente($idGerente)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdGerente', array($idGerente));

        return parent::setIdGerente($idGerente);
    }
    ...
    public function getIdGerente()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdGerente', array());

        return parent::getIdGerente();
    }

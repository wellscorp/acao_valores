 ...
 */
class Tecnico extends \Base\Entity\Tecnico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Tecnico' . "\0" . 'idTecnico', '' . "\0" . 'Base\\Entity\\Tecnico' . "\0" . 'nome', '' . "\0" . 'Base\\Entity\\Tecnico' . "\0" . 'idEmpresa');
        }
    ...
    public function getIdTecnico()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdTecnico();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdTecnico', array());

        return parent::getIdTecnico();
    }
